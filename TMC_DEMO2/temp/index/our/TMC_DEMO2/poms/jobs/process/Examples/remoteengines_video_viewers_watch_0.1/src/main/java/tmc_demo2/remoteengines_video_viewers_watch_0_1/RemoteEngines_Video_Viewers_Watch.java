...
/**
 * Job: RemoteEngines_Video_Viewers_Watch Purpose: Main job with movie streaming consumption use case<br>
 * Description: This Job reads and filters a log .csv file and then writes the results back locally.
The following parameters are required:

## General Parameters
- *parameter_download_path*: path of the file to be downloaded from Dropbox
- *parameter_percent_to_pay_views*: percentage of movie watched above which royalties are due
- *parameter_upload_path*: path of the folder on Dropbox <br>
 * @author 
 * @version 8.0.1.20230913_0925-patch
 * @status 
 */
public class RemoteEngines_Video_Viewers_Watch implements TalendJob {
	static {System.setProperty("TalendJob.log", "RemoteEngines_Video_Viewers_Watch.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(RemoteEngines_Video_Viewers_Watch.class);
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Zr8ogFkREei8HMEx_QibGA", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(RemoteEngines_Video_Viewers_Watch.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			strReturn = new String(commonByteArray_TMC_DEMO2_RemoteEngines_Video_Viewers_Watch, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "ILRiv5_" + subJobPidCounter.getAndIncrement());
                ...
                class BytesLimit65535_tFileOutputDelimited_2{
                    ...
                    log4jParamters_tFileOutputDelimited_2.append("Parameters:");
                        ...
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
                            log4jParamters_tFileOutputDelimited_2.append("FILENAME" + " = " + "context.parameter_upload_path");
                        log4jParamters_tFileOutputDelimited_2.append(" | ");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File(context.parameter_upload_path)).getAbsolutePath().replace("\\","/");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Temp/reject.csv")).getAbsolutePath().replace("\\","/");
                ...
                class BytesLimit65535_tFilterRow_3{
                    ...
                    log4jParamters_tFilterRow_3.append("Parameters:");
                        ...
                        log4jParamters_tFilterRow_3.append(" | ");
                            log4jParamters_tFilterRow_3.append("CONDITIONS" + " = " + "[{OPERATOR="+(">")+", RVALUE="+("context.parameter_percent_to_pay_views")+", INPUT_COLUMN="+("PercentWatched")+", FUNCTION="+("Math.abs($source) $operator $target")+"}]");
                        log4jParamters_tFilterRow_3.append(" | ");
 ...
 */
                ...
                class BytesLimit65535_tFileInputDelimited_1{
                    ...
                    log4jParamters_tFileInputDelimited_1.append("Parameters:");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("FILENAME" + " = " + "context.parameter_download_path");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                        ...
                        log4jParamters_tFileInputDelimited_1.append(" | ");
                            log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("customerId")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("movieID")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("movieDurationMinutes")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("MinutesWatched")+"}]");
                        log4jParamters_tFileInputDelimited_1.append(" | ");
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */context.parameter_download_path/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row2.customerId = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"customerId", "row2", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row2.movieID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"movieID", "row2", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row2.movieDurationMinutes = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"movieDurationMinutes", "row2", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row2.MinutesWatched = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",ex_tFileInputDelimited_1.getMessage());
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"MinutesWatched", "row2", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
...
if(row2 != null) { 
	...
	currentComponent="tMap_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row2","tFileInputDelimited_1","tFileInputDelimited_1","tFileInputDelimited","tMap_1","tMap_1","tMap"
...
PercentOut_tmp.PercentWatched = (float)row2.MinutesWatched / (float)row2.movieDurationMinutes ;
PercentOut = PercentOut_tmp;
log.debug("tMap_1 - Outputting the record " + count_PercentOut_tMap_1 + " of the output table 'PercentOut'.");
...
if(PercentOut != null) { 
	...
	currentComponent="tFilterRow_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"PercentOut","tMap_1","tMap_1","tMap","tFilterRow_3","tFilterRow_1","tFilterRow"
    ...
    Operator_tFilterRow_3 ope_tFilterRow_3 = new Operator_tFilterRow_3("&&");    
        ope_tFilterRow_3.matches((Math.abs(PercentOut.PercentWatched) > context.parameter_percent_to_pay_views)
            ...
            if (row5 == null){
              row5 = new row5Struct();
	            ...
	            row5.errorMessage = ope_tFilterRow_3.getErrorMsg();
					...
					log.debug("tFilterRow_3 - Reject the record " + (nb_line_tFilterRow_3+1) + ". Caused by: " + row5.errorMessage+ ".");
...
if(row3 != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tFilterRow_3","tFilterRow_1","tFilterRow","tFileOutputDelimited_2","tFileOutputDelimited_2","tFileOutputDelimited"
...
if(row5 != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row5","tFilterRow_3","tFilterRow_1","tFilterRow","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited"
		...
		resourceMap.put("finish_tFileOutputDelimited_2", true);
				...
				log.debug("tFileOutputDelimited_2 - Written records count: " + nb_line_tFileOutputDelimited_2 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tFilterRow_3","tFilterRow_1","tFilterRow","tFileOutputDelimited_2","tFileOutputDelimited_2","tFileOutputDelimited","output")) {
						talendJobLogProcess(globalMap);
					}
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				log.debug("tFileOutputDelimited_1 - Written records count: " + nb_line_tFileOutputDelimited_1 + " .");
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row5",2,0,
			 			"tFilterRow_3","tFilterRow_1","tFilterRow","tFileOutputDelimited_1","tFileOutputDelimited_1","tFileOutputDelimited","reject")) {
						talendJobLogProcess(globalMap);
					}
...
public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "peQnik_" + subJobPidCounter.getAndIncrement());
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'RemoteEngines_Video_Viewers_Watch' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-11-29T09:16:21.576469500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = RemoteEngines_Video_Viewers_Watch.class.getClassLoader().getResourceAsStream("tmc_demo2/remoteengines_video_viewers_watch_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = RemoteEngines_Video_Viewers_Watch.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        if(context.getStringValue("parameter_percent_to_pay_views") == null) {
                            ...
                            try{
                                context.parameter_percent_to_pay_views=routines.system.ParserUtils.parseTo_Float (context.getProperty("parameter_percent_to_pay_views"));
                            } catch(NumberFormatException e){
                                log.warn(String.format("Null value will be used for context parameter %s: %s", "parameter_percent_to_pay_views", e.getMessage()));
                                context.parameter_percent_to_pay_views=null;
                            }
                        }
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("parameter_download_path")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RemoteEngines_Video_Viewers_Watch");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'RemoteEngines_Video_Viewers_Watch' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     147077 characters generated by Talend Cloud Data Fabric 
 *     on the November 29, 2024 at 9:16:21 AM GMT
 ************************************************************************************************/